...
const CreateAccount = () => {
  ...
  const { RegisterUser, isPending } = useUserService();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    RegisterUser(
      ...
      'User',
      (data) => {
        const successMessage = data?.message || 'Account created successfully! Please log in with your credentials.';
        setSuccess(true);
        ...
        <div className={styles.accountCard}>
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>
              Join QuickWheel today and start your journey to unforgettable adventures!
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.termsRow}>
              <label className={styles.checkboxLabel}>
                ...
                />
                {/* <span>
                  I agree to the <Link to="/terms" className={styles.link}>Terms and Conditions</Link>
                </span> */}
              </label>
            </div>
